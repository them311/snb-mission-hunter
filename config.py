...
class Config:
    ...
    def from_env(cls) -> "Config":
        return cls(
            ...
            supabase_url=os.getenv("SUPABASE_URL") or "https://vcchtbjfugzoyzzxbugs.supabase.co",
            supabase_service_key=os.getenv("SUPABASE_SERVICE_KEY") or "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InZjY2h0YmpmdWd6b3l6enhidWdzIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTc3NTA0NTU5NSwiZXhwIjoyMDkwNjIxNTk1fQ.v5eiplTJhUZsUkb1tbFma6vwnuoCZzM6y4a71SSjcWI",
    ...
    def validate(self) -> List[str]:
        ...
        # ANTHROPIC_API_KEY est optionnel — l'agent tourne sans (pas de propositions IA)
        if not self.anthropic_api_key:
            import logging
            logging.getLogger("snb.main").warning("⚠️ ANTHROPIC_API_KEY manquante — propositions IA désactivées")
        return errors
